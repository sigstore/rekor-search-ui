// To parse this data:
//
//   import { Convert, Alpine } from "./file";
//
//   const alpine = Convert.toAlpine(json);
//
...
export class Convert {
    public static toAlpine(json: string): Alpine {
        return cast(JSON.parse(json), r("Alpine"));
    }

    public static alpineToJson(value: Alpine): string {
        return JSON.stringify(uncast(value, r("Alpine")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Package": o([
        ...
        { json: "pkginfo", js: "pkginfo", typ: u(undefined, m("")) },
    ], "any"),
    "Hash": o([
