// To parse this data:
//
//   import { Convert, RPM } from "./file";
//
//   const rPM = Convert.toRPM(json);
//
...
export class Convert {
    public static toRPM(json: string): RPM {
        return cast(JSON.parse(json), r("RPM"));
    }

    public static rPMToJson(value: RPM): string {
        return JSON.stringify(uncast(value, r("RPM")), null, 2);
    }
}
